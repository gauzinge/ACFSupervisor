...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="div[@class='CBC']" name="CBC_Settings">
           ...
           <Misc analogmux="{//input[starts-with(@name,'CBC_') and contains(@name,'_misc_amux')]/@value}" pipelogic="{//input[starts-with(@name,'CBC_') and contains(@name,'_misc_pipelogic')]/@value}" stublogic="{//input[starts-with(@name,'CBC_') and contains(@name,'_misc_stublogic')]/@value}" or254="{//input[starts-with(@name,'CBC_') and contains(@name,'_misc_or254')]/@value}" tpgclock="{//input[starts-with(@name,'CBC_') and contains(@name,'_misc_tpgclock')]/@value}" testclock="{//input[starts-with(@name,'CBC_') and contains(@name,'_misc_testclock')]/@value}" dll="{//input[starts-with(@name,'CBC_') and contains(@name,'_misc_dll')]/@value}"/>
