...
UserDynamicLinkFlags = ${LibraryPaths} $(shell pkg-config --libs libxml++-2.6) $(shell xslt-config --libs) -lxdaq2rc -lPh2_Utils -lPh2_Description -lPh2_Interface -lPh2_System -lPh2_Tools 
